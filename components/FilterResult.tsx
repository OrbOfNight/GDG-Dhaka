...
const FilterResult: React.FC<FilterResultProps> = ({ result, onTryAgain }) => {
  ...
  return (
    <div className="flex flex-col items-center text-center animate-fade-in">
      ...
      <p className="text-slate-600 text-lg mb-8 max-w-prose">
        <span className="font-semibold text-slate-800">Reason:</span> {result.reason}
      </p>

      <button
        onClick={onTryAgain}
        className="px-8 py-3 bg-slate-200 text-slate-700 font-semibold rounded-lg hover:bg-slate-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-slate-400 transition-colors duration-200"
      >
